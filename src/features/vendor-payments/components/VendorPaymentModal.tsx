...
import {createVendorPaymentAction} from "@/features/vendor-payments/actions/trip-vendor-payment.actions";
...
export default function VendorPaymentModal({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const result = await createVendorPaymentAction(tenantSlug, {
        vendor_id: vendorId,
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-purple-900/40 p-4">
      <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-2xl">
        <div className="mb-4">
          <h3 className="text-xl font-bold text-slate-900">Pay Vendor</h3>
