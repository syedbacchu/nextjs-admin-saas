...
import {
    ...
    DriverVehicleCategoryListData,
    DriverVehicleCategoryListResponse,
...
export const DriverService = {
    ...
    vehicleCategories(page: number = 1, search: string = ''): Promise<DriverVehicleCategoryListResponse> {
        return request<DriverVehicleCategoryListData>({
            method: 'GET',
